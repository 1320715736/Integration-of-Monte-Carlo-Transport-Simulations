...
def build_optical_generation_dataset(values: list[float]) -> list[str]:
    dataset_lines = [
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--input-values",
        default=str(Path("step5_output") / "optical_generation_values.csv"),
    ...
    parser.add_argument(
        "--output-name",
        default="n51_optical_generation.dat",
...
def main() -> int:
    ...
    dataset_lines = build_optical_generation_dataset(values)
