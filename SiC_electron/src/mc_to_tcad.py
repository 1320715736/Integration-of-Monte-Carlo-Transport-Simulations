...
# Source: Chaudhuri et al., Applied Physics Letters 102, 032108 (2013).
EH_PAIR_ENERGY_EV = 7.28
...
def build_2d_intermediate_picture(
    ...
    *,
    ...
    summary = {
        "material": "SiC",
        "eh_pair_energy_assumption": "4H-SiC average electron-hole pair creation energy",
        "carrier_generation_energy_ev": float(EH_PAIR_ENERGY_EV),
        "carrier_generation_energy_source": "Chaudhuri et al., Appl. Phys. Lett. 102, 032108 (2013)",
